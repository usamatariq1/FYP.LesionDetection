...
@NgModule({
  declarations: [AssistantComponent, ViewAppointmentsComponent, ViewSpecificPatientComponent, ViewPatientsComponent, ViewTestsComponent, ViewSpecificTestComponent, ViewSpecificLabAssistantComponent, ChangePasswordComponent, BasicComponent, PerformTestComponent, ],
  imports: [
    CommonModule,
