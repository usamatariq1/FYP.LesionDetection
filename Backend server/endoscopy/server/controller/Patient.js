...
// Respond with valid data
    ...
    exports.patient_getPassword= function(req){
    ...
    text: 'Your password is: faiqPass'
    };
    ...
    /* exports.getEndoscopyImages = function(req, res) {
        var images=[];
        endoscopyDirectoryPath= path.join("E:/Studies/Wireless capsule endoscopy for shifa international hospital/Backend server/endoscopy/assets/", this.email);
